...
public class patientList extends Application {
    public void start(Stage primaryStage) {
        ...
        viewButton.setMinWidth(150.0);
        Button addButton = new Button("Add");
        addButton.setStyle("-fx-background-color: lightblue; -fx-padding:10px");
        addButton.setMinWidth(150.0);
        Button updateButton = new Button("Update");
        updateButton.setStyle("-fx-background-color: lightblue; -fx-padding:10px");
        updateButton.setMinWidth(150.0);
        ...
        buttonsVBox.getChildren().addAll(viewButton, addButton, updateButton, searchField, searchButton, BackButton);
